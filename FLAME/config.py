...
parser.add_argument(
    '--flame_model_path',
    type = str,
    default = 'C:/Content/Python/AvatarAnimation/FLAME/model/generic_model.pkl',
...
parser.add_argument(
    ...
    type = str,
    default = 'C:/Content/Python/AvatarAnimation/FLAME/model/flame_static_embedding.pkl',
...
parser.add_argument(
    ...
    type = str,
    default = 'C:/Content/Python/AvatarAnimation/FLAME/model/flame_dynamic_embedding.npy',
